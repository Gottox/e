...
test_type_basename_array(void) {
	...
	parse_json(
			ctx, &val,
			"{\"kind\":\"array\",\"element\":{\"kind\":\"reference\",\"name\":"
			"\"my_type\"}}");
	char *bn = type_basename(&val);
...
test_type_basename_map(void) {
	...
	parse_json(
			ctx, &val,
			"{\"kind\":\"map\",\"key\":{\"kind\":\"reference\",\"name\":\"my_"
			"key\"},\"value\":{\"kind\":\"reference\",\"name\":\"my_value\"}}");
	char *bn = type_basename(&val);
...
test_collect_deps_map(void) {
	...
	parse_json(
			ctx, &val,
			"{\"kind\":\"map\",\"key\":{\"kind\":\"reference\",\"name\":\"my_"
			"key\"},\"value\":{\"kind\":\"reference\",\"name\":\"EnumType\"}}");
	collect_deps(&val, &enums, &deps);
	jw_cleanup(&val);
	ASSERT_EQ(deps.count, 1);
	...
	parse_json(
			ctx, &val,
			"{\"kind\":\"map\",\"key\":{\"kind\":\"reference\",\"name\":\"my_"
			"key\"},\"value\":{\"kind\":\"reference\",\"name\":\"MyStruct\"}}");
	collect_deps(&val, &enums, &deps);
	jw_cleanup(&val);
